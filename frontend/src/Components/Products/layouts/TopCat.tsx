        ...
        <div className="w-full md:py-5 lg:py-6">
            <div className="flex overflow-x-auto gap-3 md:gap-4 px-1 scrollbar-hide scroll-smooth justify-start md:justify-center">
                {categories.map((cat) => (
                    ...
                    >
                        <div
                            className="px-4 py-2 rounded-full bg-gray-100 hover:bg-amber-100 hover:text-amber-700 cursor-pointer transition-colors duration-200 whitespace-nowrap"
                        >
                            <span className="text-sm font-medium text-gray-700 group-hover:text-amber-700 transition-colors duration-200">
                                {cat.name}
                            </span>
                        </div>
                    </Link>
