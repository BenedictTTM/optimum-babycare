...
const PromotionalCards = () => {
  return (
    <div className="w-full  sm:px-2 lg:px-5 md:py-7">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        <PromotionalCard
          badge="Hot Offer"
          title={
             <>
               <span className='text-black'> Get</span> <span className="text-2xl md:text-4xl text-red-600 font-semibold">80% Off</span>
              </>
          }
        ...
        <PromotionalCard
          badge={<span className="text-sm md:text-2xl font-bold text-gray-800 tracking-wide">Summer Offer</span>}
