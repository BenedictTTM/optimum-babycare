 ...
 * ```tsx
 * <SEO
 *   title="Buy Laptops — babylist"
 *   description="Affordable laptops for UG students."
 *   canonical="https://babylist.shop/products/laptop-123"
 *   og={{
...
export default function SEO({
  ...
  const domain = process.env.NEXT_PUBLIC_SITE_URL || "https://babylist.shop";
  ...
  return (
    <Head>
      ...
      <meta property="og:image:alt" content="babylist — campus marketplace" />
