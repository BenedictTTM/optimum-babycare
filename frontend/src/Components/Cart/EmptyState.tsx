  ...
  return (
    <div className=" p-4 sm:p-8 md:p-12 text-center max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl mx-auto">
      ...
      <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mb-4 sm:mb-6">
        <ShoppingCart className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-amber-400" strokeWidth={1.5} />
      </div>
      ...
      <Link
        href="/products"
        className="inline-flex items-center justify-center gap-2 bg-amber-400 hover:bg-red-700 active:bg-red-800 text-white font-semibold px-6 sm:px-8 md:px-10 py-2.5 sm:py-3 md:py-3.5 rounded-lg transition-all shadow-md hover:shadow-lg text-xs sm:text-sm md:text-base w-full sm:w-auto"
      >
        Continue Shopping
      </Link>
