/**
 * Enhanced Local Business Schema for babylist
...
export function generateLocalBusinessSchema() {
  const schema = {
    ...
    "@type": "LocalBusiness",
    "@id": "https://babylist.shop/#localbusiness",

    // Basic Information
    "name": "babylist",
    "alternateName": "babylist Ghana",
    ...
    // Contact Information
    "url": "https://babylist.shop",
    "email": "support@babylist.shop",
    ...
    // Visual Identity
    "logo": "https://babylist.shop/logo.png",
    "image": [
      "https://babylist.shop/og-image.jpg",
      "https://babylist.shop/campus-delivery.jpg",
      "https://babylist.shop/student-marketplace.jpg"
    ],

    // Social Media Profiles
    "sameAs": [
      "https://facebook.com/babylist",
      "https://instagram.com/babylist",
      "https://twitter.com/babylist",
      "https://linkedin.com/company/babylist"
    ],
...
export function generateFAQSchema() {
  return {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Is babylist only for University of Ghana students?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, babylist is exclusively designed for University of Ghana (UG Legon) students to buy and sell products safely within the campus community. All sellers are verified UG students, ensuring a trusted and familiar trading environment."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sellers on babylist offer two convenient delivery options: (1) Campus Delivery - items delivered directly to your hall or residence for GH₵5-10, typically same-day or next-day, or (2) Campus Meetup - arrange a free meetup at a public campus location like the library, night market, or your hall's entrance."
        }
      },
      {
        "@type": "Question",
        "name": "What payment methods are accepted on babylist?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "babylist supports multiple payment methods including Mobile Money (MTN Mobile Money, Vodafone Cash, AirtelTigo Money), bank transfer, and cash on delivery. We recommend inspecting items before making payment and using secure payment methods. Never send advance payment without seeing the item first."
        }
      },
      {
        "@type": "Question",
        "name": "How much can I save buying on babylist compared to retail stores?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "UG students typically save 40-60% compared to retail stores when buying on babylist. For example: laptops range from GH₵500-2,000 (retail: GH₵1,500-4,000), textbooks from GH₵10-100 (retail: GH₵50-200), smartphones from GH₵100-1,500 (retail: GH₵300-3,000), and fashion items from GH₵5-150 (retail: GH₵20-300)."
        }
      },
      {
        "@type": "Question",
        "name": "How do I sell products on babylist?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Selling on babylist is easy! Simply (1) Create a free account with your UG student email, (2) Click 'Sell Product' and upload clear photos of your item, (3) Add a detailed description, set your price, and choose your preferred delivery method, (4) Wait for interested buyers to contact you via WhatsApp or call. You'll need to purchase product slots (GH₵1 per slot) to list items."
        }
      },
      {
        "@type": "Question",
        "name": "Is it safe to buy and sell on babylist?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes! babylist prioritizes safety with several features: (1) All sellers must verify their UG student status, (2) Buyers can see seller ratings and reviews from other students, (3) We recommend meeting in public campus areas during daylight hours, (4) Always inspect items before payment, (5) Use our messaging system for communication records. Report any suspicious activity to our support team immediately."
        }
      },
      {
        "@type": "Question",
        "name": "What categories of products can I find on babylist?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "babylist offers a wide range of student essentials organized into categories: Electronics (laptops, phones, tablets, accessories), Books & Course Materials (textbooks, study guides, novels), Fashion & Accessories (clothing, shoes, bags, jewelry), Home & Living (furniture, appliances, decor), Sports & Outdoors (equipment, gear, fitness items), and Others (miscellaneous student needs)."
        }
      },
      {
        "@type": "Question",
        "name": "Can I return or exchange items bought on babylist?",
        "acceptedAnswer": {
          "@type": "Answer",
...
export function generateServiceSchema() {
  return {
    ...
    "provider": {
      "@type": "Organization",
      "name": "babylist",
      "@id": "https://babylist.shop/#organization"
    },
    "areaServed": {
      "@type": "City",
      "name": "Accra",
