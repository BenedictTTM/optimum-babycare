                ...
                {feedbacks.map((feedback) => {
                    ...
                    return (
                        <div key={feedback.id} className="bg-white rounded-lg shadow-sm p-4 border border-gray-200 hover:shadow-md transition-shadow relative">
                            ...
                            <div className="flex items-start justify-between mb-3">
                                <div className="flex items-center gap-3">
                                    {feedback.user?.profilePic ? (
                                        ...
                                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-400 to-amber-400 flex items-center justify-center text-white text-sm font-semibold shadow-inner">
                            ...
                            {/* Admin Reply Section */}
                            {feedback.adminReply ? (
                                <div className="bg-amber-50/50 border-l-[3px] border-amber-400 pl-3 py-2 pr-2 rounded-r">
                                ...
                                <div>
                                    {!isReplying ? (
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 px-3 py-1.5 bg-amber-400 text-white text-sm rounded bg-opacity-90 hover:bg-opacity-100 transition-all shadow-sm"
                                        >
                                        ...
                                        <div className="border border-gray-200 rounded-lg p-3 bg-gray-50/30">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full border border-gray-300 rounded p-2 mb-2 text-sm focus:ring-1 focus:ring-amber-400 focus:border-transparent outline-none bg-white font-normal"
                                                rows={3}
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    disabled={submitting}
                                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-amber-400 text-white text-sm rounded hover:bg-amber-800 transition-colors disabled:opacity-50 shadow-sm"
                                                >
                                                    <Send size={14} />
