...
export default function CategoriesPage() {
    ...
    return (
        <div className="min-h-screen px-4 py-10 sm:px-2 lg:px-8">
            <div className="mx-auto max-w-6xl">
                ...
                <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="rounded-lg bg-white border border-gray-200 p-4">
                        ...
                        <p className="mt-1 text-2xl font-bold text-amber-700">{totalProducts}</p>
                    </div>
                </div>
                ...
                <section className="rounded-2xl bg-white p-6 shadow-sm">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 rounded-lg bg-amber-700 px-5 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-amber-800"
                        >
            ...
            {toast && (
                <div
                    className={`fixed bottom-6 right-6 z-50 rounded-lg px-6 py-3 shadow-lg ${toast.type === 'success' ? 'bg-green-600 text-white' : 'bg-amber-700 text-white'}`}
                >
