...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-12 lg:py-16 px-4 sm:px-6 lg:px-12 ">
      {/* Header */}
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-6 sm:p-8 lg:p-10 hover:shadow-xs transition-shadow duration-200 flex flex-col items-center text-center w-full">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-red-50 flex items-center justify-center mb-5">
              <MessageCircle className="w-6 sm:w-9 h-6 sm:h-9 text-amber-600" aria-hidden="true" />
            </div>
            ...
            <a
              ...
              className="bg-amber-600 hover:bg-amber-700 focus:ring-2 focus:ring-red-400 focus:ring-offset-2 text-white w-full py-2 sm:py-3 rounded-md text-sm sm:text-sm font-medium transition-colors"
            >
              Chat Now
            </a>
          </div>
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-6 sm:p-8 lg:p-10 hover:shadow-xs transition-shadow duration-200 flex flex-col items-center text-center w-full">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-red-50 flex items-center justify-center mb-5">
              <Phone className="w-6 sm:w-9 h-6 sm:h-9 text-amber-600" aria-hidden="true" />
            </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 sm:p-8 lg:p-10 ">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-amber-700 focus:ring-2 focus:ring-red-400 focus:ring-offset-2 text-white w-full py-3 rounded-md text-sm font-medium transition-colors flex items-center justify-center"
            >
