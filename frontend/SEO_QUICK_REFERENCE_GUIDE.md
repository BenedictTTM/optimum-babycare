...
```
<Primary Keyword> — babylist
```

**Examples:**

- `Campus Phone Sales — babylist`
- `Used Textbooks — babylist`
- `Dell Latitude Laptop — babylist`
- `Student Fashion — babylist`

**Rules:**

- Keep short (50-60 chars)
- Include one primary keyword
- Always end with "— babylist"
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${product.title} — babylist`,
    description: `${product.description.substring(0, 150)}. Meet on campus.`,
    alternates: {
      canonical: `https://babylist.shop/product/${params.id}`,
    },
    openGraph: {
      title: product.title,
...
const faqSchema = generateFAQSchema([
  {
    question: "How do I buy on babylist?",
    answer:
...
```
https://babylist.shop/robots.txt
https://babylist.shop/sitemap.xml
https://babylist.shop/main/products/[id]
```
...
export const metadata: Metadata = {
  title: "New Page — babylist",
  description: "Short student-friendly description here.",
  alternates: {
    canonical: "https://babylist.shop/new-page",
  },
};
...
```tsx
openGraph: {
  images: ["https://babylist.shop/og-default.png"];
}
```
...
```tsx
alternates: {
  canonical: "https://babylist.shop/your-page";
}
```
...
- [ ] **Title** - Short, keyword-rich, ends with "— babylist"
...
```
Title: babylist — Buy & Sell on Campus (University of Ghana)
Description: Buy, sell, and swap on campus. babylist connects University of Ghana students for books, gadgets, textbooks and more. Fast, local, student-friendly.
```

### Product Page

```
Title: Used MacBook Pro 2016 — babylist
...
```
Title: Campus Phone Sales — babylist
...
```
Title: About babylist — Campus Marketplace
...
```
Title: Help — babylist
Description: How to list items, safety tips for meeting on campus, and buyer protection — everything you need to trade safely on babylist.
```

### Contact Page

```
Title: Contact — babylist
Description: Need help? Contact babylist support for listing issues, disputes, or suggestions. We're students helping students.
```
